...
namespace danielebuso\sanitizer;
...
class Sanitizer
{
    ...
    protected $filters = [
        ...
        'cast'        => \danielebuso\sanitizer\Filters\Cast::class,
        ...
        'strip_tags'  => \danielebuso\sanitizer\Filters\StripTags::class,
        'digit'       => \danielebuso\sanitizer\Filters\Digit::class,
        'filter_if'   => \danielebuso\sanitizer\Filters\FilterIf::class,
    ];
